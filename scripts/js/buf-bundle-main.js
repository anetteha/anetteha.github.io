...
Form.propTypes = {
  ...
  /** Legal values are \_blank, \_parent, \_top, or a name representing the name of an iframe */
...
var Fieldset = function (_PureComponent) {
...
Input.propTypes = {
  /** Available types are "text", "number", "password" and "email" */
  type: _propTypes2.default.string,
  /** Id must match associated label for */
  id: _propTypes2.default.string,
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.left ? '' + this.props.text : null,
          this.props.children,
          this.props.right ? '' + this.props.text : null
        )
      );
    }
  }]);
...
Label.propTypes = {
  /** Add class to < label > */
  class: _propTypes2.default.string,
  /** For must match associated input id */
...
Textarea.propTypes = {
  ...
  placeholder: _propTypes2.default.string,
  /** Specifies a default value of a textarea */
...
var _Fieldset = __webpack_require__(23);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          'Her er en visning av tilgjengelige komponenter.'
        ),
        _react2.default.createElement(
          'h2',
          null,
...
*/
var aa=__webpack_require__(6),ba=__webpack_require__(0),m=__webpack_require__(13),p=__webpack_require__(4),v=__webpack_require__(5),da=__webpack_require__(14),ea=__webpack_require__(15),fa=__webpack_require__(16),ha=__webpack_require__(7);
...
// -------------------------------------------------------------------------------
//
// Description: Import other blocks here
// ===============================================================================
//
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // -------------------------------------------------------------------------------
//
// Description: Alerts, such as error, info, success and warning
// ===============================================================================
//
...
var Alert = function (_PureComponent) {
  ...
  _createClass(Alert, [{
    key: 'render',
    value: function render() {
      var componentClassNames = (0, _classnames2.default)('buf-alert', {
        'buf-alert--error': this.props.style === 'error',
        'buf-alert--info': this.props.style === 'info',
        'buf-alert--success': this.props.style === 'success',
        'buf-alert--warning': this.props.style === 'warning'
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: componentClassNames, role: 'alert' },
          this.props.icon ? _react2.default.createElement(
            'div',
            { className: 'buf-alert__icon' },
            this.props.style === 'error' ? _react2.default.createElement('i', { className: 'fas fa-times' }) : '',
            this.props.style === 'info' ? _react2.default.createElement('i', { className: 'fas fa-info-circle' }) : '',
            this.props.style === 'success' ? _react2.default.createElement('i', { className: 'fas fa-check-circle' }) : '',
            this.props.style === 'warning' ? _react2.default.createElement('i', { className: 'fas fa-exclamation-circle' }) : ''
          ) : '',
          _react2.default.createElement(
            'div',
            { className: 'buf-alert__content ' + (this.props.removePadding === true ? 'buf-alert__content--small' : '') },
            this.props.title ? _react2.default.createElement(
              'h2',
              { className: 'buf-alert__title' },
              this.props.title
            ) : null,
            _react2.default.createElement(
              'div',
              { className: 'buf-alert__text ' + (this.props.textSmall === true ? 'buf-alert__text--small' : '') },
              this.props.text
            )
          )
        )
...
Alert.propTypes = {
  /** Choose between these styles */
  style: _propTypes2.default.oneOf(['error', 'info', 'success', 'warning']),
  title: _propTypes2.default.string,
  text: _propTypes2.default.string.isRequired,
  /** Set smaller font-size (used to show alerts with e.g. input fields) */
  textSmall: _propTypes2.default.bool,
  /** Choose to show icon */
  icon: _propTypes2.default.bool,
  /** Remove large padding (used to show alerts with e.g. input fields) */
  ...
  _createClass(Link, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { className: 'buf-link ' + this.props.class, href: this.props.href, target: this.props.target },
          this.props.text
        )
      );
    }
...
Link.propTypes = {
  ...
  /** Add text */
  text: _propTypes2.default.string,
  target: _propTypes2.default.oneOf(['_blank'])
};
...
var Button = function (_PureComponent) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var componentClassNames = (0, _classnames2.default)('buf-btn', {
        'buf-btn--small': this.props.size === 'small',
        'buf-btn--regular': this.props.size === 'regular',
        'buf-btn--large': this.props.size === 'large',

        'buf-btn--filled': this.props.skin === 'filled',
        'buf-btn--outline': this.props.skin === 'outline',
        'buf-btn--flat': this.props.skin === 'flat',

        'buf-sr-only': this.props.textHide === true
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          {
            id: this.props.id,
            className: componentClassNames + ' ' + (this.props.accent === true ? 'buf-btn--accent' : null),
            type: this.props.type,
            size: this.props.size,
            disabled: this.props.disabled },
          _react2.default.createElement(
            'span',
            { className: 'buf-btn__content' },
            this.props.iconAlign === 'left' ? _react2.default.createElement('i', { className: 'buf-btn__icon buf-btn__icon-left ' + this.props.icon, 'aria-hidden': 'true' }) : null,
            _react2.default.createElement(
              'span',
              { className: 'buf-btn__text' },
              this.props.textHide ? null : '' + this.props.text
            ),
            this.props.iconAlign === 'right' ? _react2.default.createElement('i', { className: 'buf-btn__icon buf-btn__icon-right ' + this.props.icon, 'aria-hidden': 'true' }) : null
          )
        )
      );
    }
...
Button.propTypes = {
  ...
  id: _propTypes2.default.string,
  /** Choose between these styles */
  skin: _propTypes2.default.oneOf(['filled', 'outline', 'flat']),
  /** Add accent color */
  accent: _propTypes2.default.bool,
  /** Choose between these sizes */
  size: _propTypes2.default.oneOf(['small', 'regular', 'large']),
  /** Choose an icon from [font-awesome](https://fontawesome.com/) */
  icon: _propTypes2.default.string,
  /** Icon align left or right */
  iconAlign: _propTypes2.default.oneOf(['left', 'right']),
  /** Choose between these types */
  type: _propTypes2.default.oneOf(['button', 'submit', 'reset']),
  /** Specifies that a < button > element should be disabled */
  disabled: _propTypes2.default.bool,
  /** Button text description */
  text: _propTypes2.default.string.isRequired,
  /** Hide text visually. Still accessible for screen readers */
  textHide: _propTypes2.default.bool
};
...
var ButtonGroup = function (_PureComponent) {
  ...
  _createClass(ButtonGroup, [{
    key: 'render',
    value: function render() {
      var componentClassNames = (0, _classnames2.default)('buf-btn-group', {
        'buf-btn-group--vertical': this.props.vertical === true
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: componentClassNames, role: 'group' },
          this.props.children
        )
      );
    }
...
var InputButton = function (_PureComponent) {
  _inherits(InputButton, _PureComponent);
...
InputButton.propTypes = {
  ...
  /** Add class to < input > */
  class: _propTypes2.default.string,
  /** Available types are "button", "submit" and "reset" */
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // -------------------------------------------------------------------------------
//
// Description: Form switch controller (radio button and checkboxes)
// ===============================================================================
//
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', {
          ...
          name: this.props.name,
          value: this.props.value,
          checked: this.props.checked ? this.state.selected === '' + this.props.value : null,
          onChange: this.props.checked ? function (e) {
            return _this2.setState({ selected: e.target.value });
          } : null })
      );
    }
  }]);
...
Switch.propTypes = {
  ...
  /** Add class to < input > */
  class: _propTypes2.default.string,
  /** Available options are radio and checkbox */
  type: _propTypes2.default.string,
  /** Specifies the name of an < input > element */
  ...
  _createClass(Heading, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        _react.Fragment,
        null,
        this.props.size === 1 ? _react2.default.createElement(
          'h1',
          null,
          this.props.text
        ) : null,
        this.props.size === 2 ? _react2.default.createElement(
          'h2',
          null,
          this.props.text
        ) : null,
        this.props.size === 3 ? _react2.default.createElement(
          'h3',
          null,
          this.props.text
        ) : null,
        this.props.size === 4 ? _react2.default.createElement(
          'h4',
          null,
          this.props.text
        ) : null,
        this.props.size === 5 ? _react2.default.createElement(
          'h5',
          null,
          this.props.text
        ) : null,
        this.props.size === 6 ? _react2.default.createElement(
          'h6',
          null,
          this.props.text
        ) : null
...
/***/ })
/******/ ]);
//# sourceMappingURL=buf-bundle-main.js.map
